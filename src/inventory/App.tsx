    ...
    <div className="inv-app">
      <header className="inv-top no-print">
        <div className="inv-brand">
          ...
          <div>
            <h1>مخزون شاورما</h1>
            <p>مشتريات الصباح · جرد المساء · رصيد يُرحَّل تلقائياً</p>
          </div>
        </div>
      ...
      <section className="inv-day no-print">
        <div className="inv-day-head">
          <div>
            ...
            <p>
              الرصيد الافتتاحي = آخر جرد سابق · الاستهلاك = أول المدة + المشتريات − الجرد
            </p>
          </div>
      ...
      {mode === 'morning' && (
        <section className="inv-sheet">
          <div className="inv-sheet-head">
            ...
            <p>أدخل الكمية والتكلفة. الخضار تُسجَّل بالريال كما في السوق.</p>
          </div>
          {Object.keys(data[branch]).length === 0 && (
            <p className="inv-warn">
              أول استخدام: اكتب الرصيد الحالي في خانة «رصيد أول المدة»، ثم أدخل مشتريات اليوم.
            </p>
          )}
      ...
      {mode === 'evening' && (
        <section className="inv-sheet">
          <div className="inv-sheet-head">
            ...
            <p>
              الجرد اليومي للأصناف سريعة الحركة. الباقي يُجرد أسبوعياً حتى لا يتعطّل الإغلاق.
            </p>
          </div>
      ...
      {mode === 'report' && (
        <section className="inv-sheet">
          ...
          <div className="inv-notes">
            <h4>طريقة العمل المقترحة</h4>
            <ol>
              <li>الصباح: إدخال مشتريات الدجاج والخضار والخبز قبل فتح المطعم.</li>
              <li>المساء: جرد الأصناف اليومية فقط (دجاج، خضار، خبز، بهارات، ثومية).</li>
              <li>مرة كل أسبوع: جرد الزيت والمجمدات والصوصات والبلاستيك.</li>
              <li>الرصيد المتبقي يُصبح أول مدة لليوم التالي تلقائياً.</li>
            </ol>
          </div>
